...
% \begin{table}[H]
%     \centering
%     \caption{Datos generales del proyecto para el seminario VI}
%     \begin{tabular}{p{8cm} c}
%     \hline
%          NOMBRE DEL PROYECTO & CATEGORÍA EN LA QUE PARTICIPA\\
%     \hline
%         Resumen de PMBOK sexta edición 
%             & \\
%     \hline
%     \end{tabular}
%     \label{tab:my_label}
...
% \begin{table}[H]
%     \centering
%     \caption{Alumnos responsables del proyecto}
%     \begin{tabular}{l l}
%          \hline
%          Nombre & Correo electrónico \\
%          \hline
%          Gendry Alfonso Francia & gendry07@gmail.com\\
%          Ireri Graciela Segura Gutierrez & irerisegura@gmail.com \\
%          Julio Alberto Ramírez Montañez &  julio.ramirezm27@gmail.com\\
%          Luis Alberto Ángeles Hurtado   &  alb3rt0.ah@gmail.com\\
%          \hline
%     \end{tabular}
%     \label{tab:my_label}
% \end{table}
...
% \begin{table}[H]
%     \centering
%     \caption{Profesor corresponsable}
%     \begin{tabular}{l l}
%          \hline
%          Nombre& Juan Carlos Jáuregui \\
%          Correo electrónico & juancarlosjauregui2007@gmail.com  \\
%          \hline
%     \end{tabular}
%     \label{tab:my_label}
% \end{table}
